...
<p class="textofoto">Titulli <?php echo $data['json']->{'title'} ?></p>
<p class="textfoto">Pershkrimi i saj : <?php echo getFirstLine($data['json']->{'explanation'}) ?></p>

<img style="width:500px;height:500px;" src="<?= $data['json']->{'url'} ?>">
